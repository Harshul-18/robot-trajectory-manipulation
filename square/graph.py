...
def generate_expected_coordinates(length, a, b):
    ...
    for i in range(2, step):
	    x_expected.append(i/step)
	    y_expected.append(0)
    for i in range(step):
	    x_expected.append(a)
	    y_expected.append(i/step)
    for i in range(step):
	    x_expected.append(a - (i/step))
	    y_expected.append(a)
    for i in range(step):
	    x_expected.append(0)
	    y_expected.append(a - (i/step))
...
if __name__ == "__main__":
    filename = 'pid_fractional_square_real.txt'
